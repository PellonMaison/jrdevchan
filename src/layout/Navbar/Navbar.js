                ...
                <div>
                    <ul>
                       <li><NavLink to='/'
                         ...
                         onClick={() => this.props.changeCategoryAction("all")}>All</NavLink></li> 
                       <li><NavLink to='/'
                       
      onClick={() => this.props.changeCategoryAction("tech")}>Tech</NavLink></li> 
                        <li><NavLink to='/'
                         onClick={() => this.props.changeCategoryAction("clothes")}>Clothes</NavLink></li>
                    </ul> 
                </div>
                <Link to={'/'}>
                    <div>
